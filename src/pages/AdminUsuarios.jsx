...
export default function AdminUsuarios() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-white to-slate-100">
      <div className="max-w-4xl mx-auto px-6 py-10" id="print-area">
        ...
        <PrintHeader title="Listado de usuarios — Pegaso Control UAS" />
                          ...
                          <TableCell>
                            {isSuperadmin && !isSelf && !isTargetSuperadmin ? (
                              <>
                                ...
                                <span className="hidden print:inline">{ROLE_LABEL[u.role] || u.role}</span>
                              </>
                            ) : (
